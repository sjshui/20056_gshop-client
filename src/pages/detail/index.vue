          ...
          <div class="choose">
            <div class="chooseArea">
              ...
              <dl v-for="spuSaleAttr in spuSaleAttrList" :key="spuSaleAttr.id">
                ...
                <dd
                  changepirce="0"
                  :class="{active: spuSaleAttrValue.isChecked==='3'}"
...
export default {
  ...
  // 我们一般在beforeMount当中去处理数据，处理完成后期就可以直接使用
  beforeMount() {
  ...
  computed: {
    ...
    // categoryView(){
    //   this.$store.getters.categoryView
    // }
    ...
    async addShopCart(){
      ...
      /* 
        this.$store.dispatch('addOrUpdateCart',{skuId,skuNum}) 就是函数调用表达式
          结果就是actions当中异步函数的返回值，异步函数返回值一定是promise
      */
      ...
      try{
        ...
        // 区别： localStorage是永久储存    sessionStorage浏览器关闭就没了
